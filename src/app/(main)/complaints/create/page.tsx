    ...
    return (
        <div style={{ maxWidth: '600px', margin: '0 auto' }}>
            <div style={{ marginBottom: '2rem' }}>
                ...
                <h1 style={{ fontSize: '1.5rem', fontWeight: 700 }}>Submit New Complaint</h1>
            </div>
            ...
            <form onSubmit={handleSubmit} className="card glass-panel" style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
                    <div>
                        <label style={{ display: 'block', fontSize: '0.875rem', marginBottom: '0.5rem', fontWeight: 500 }}>Worker Involved (Optional)</label>
                        <select
                ...
                <div>
                    <label style={{ display: 'block', fontSize: '0.875rem', marginBottom: '0.5rem', fontWeight: 500 }}>Date of Complaint</label>
                    <input
                        type="date"
                        value={formData.date}
                ...
                <div style={{ paddingTop: '1rem', borderTop: '1px solid hsl(var(--border))', display: 'flex', justifyContent: 'flex-end', gap: '1rem' }}>
                    <Link href="/complaints" className="btn btn-ghost" style={{ border: '1px solid hsl(var(--border))' }}>Cancel</Link>
